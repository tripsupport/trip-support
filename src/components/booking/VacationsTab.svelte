<script>
	...
	import Vacations from '../vacations/Vacations.svelte';
	import VacationsMob from '../vacations/VacationsMob.svelte';
</script>
...
<div class="col-span-12 md:col-span-4 flex md:justify-end justify-start">
	...
	<div class="sm:hidden fex col-span-2 lg:col-span-1">
		<RoomsMob />
	</div>
</div>
