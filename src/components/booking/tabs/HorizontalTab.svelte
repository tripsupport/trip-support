<script lang="ts">
	...
	// Tabs
	import FlightsTab from './VacationsTab.svelte';
	import VacationsTab from './FlightsTab.svelte';
	import HotelsTab from './HotelsTab.svelte';
	import HotelFlightTab from './HotelFlightTab.svelte';
	// Tab Content
	import FlightsTabContent from './VacationsTabContent.svelte';
	import VacationsTabContent from './FlightsTabContent.svelte';
	import HotelsTabContent from './HotelsTabContent.svelte';
	import HotelFlightTabContent from './HotelFlightTabContent.svelte';
...
<div id="myTabContent">
	...
	<div
		class="pt-2 bg-white rounded-b-lg dark:bg-gray-800"
		id="flights"
		role="tabpanel"
			...
			<div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-12">
				...
				<div class="sm:col-span-4">
					<div class="flex flex-row-reverse">
						<button
							type="button"
							class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-900 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pblue-500"
						>
	...
	<!-- End of flights tab content -->

	<!-- Vacations tab content -->
	<div
		class="hidden p-4 bg-gray-50 rounded-b-lg dark:bg-gray-800"
		id="vacations"
		role="tabpanel"
		aria-labelledby="vacations-tab"
	>
