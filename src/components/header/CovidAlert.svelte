<!-- Covid alert -->
<div class="bg-gray-900 relative z-20">
	<div class="max-w-7xl mx-auto h-10 px-4 flex items-center justify-between sm:px-6 lg:px-8 py-7">
		<p class="flex-1 text-center text-sm text-white lg:flex-none">
