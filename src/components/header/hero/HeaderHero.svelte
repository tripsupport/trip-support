...
<div class="relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
	<div class="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-24 lg:pb-24">
		<div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
			...
			<div>
				<div class="mt-10">
					...
					>
						<div
							class="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-2/5 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8"
						>
