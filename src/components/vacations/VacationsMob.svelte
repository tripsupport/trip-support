<script>
	...
	import VacationSearchButton from './VacationSearchButton.svelte';
					...
					<div class="absolute">
						<div class="bg-white z-50 shadow sm:rounded-lg fixed w-full h-[100%] top-0 right-0">
							...
							<div>
								...
								<!-- Two arrow icon -->
								<div
									class="z-30 md:hidden absolute top-[143px] left-[90%] transform -translate-x-1/2 -translate-y-3"
								>
									<Icon
										src={SwitchHorizontal}
										class="bg-white h-8 text-pblue-900 w-8 rotate-90 border rounded-full p-[5px] border-pblue-500"
...
<div class="grid grid-cols-6 justify-self-start place-content-between md:gap-4 items-center">
	<div class="col-span-6 md:col-span-4">
		<div class="space-y-3 sm:flex sm:items-center sm:space-y-0 sm:space-x-10 xs:space-x-12">
