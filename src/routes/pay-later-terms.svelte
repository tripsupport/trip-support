...
<div class="bg-gradient-to-r from-slate-900 to-purple-900 ">
	<div class="max-w-7xl mx-auto py-16 px-4 sm:py-20 sm:px-6 lg:px-8 lg:flex lg:justify-between">
		<div class="max-w-3xl">
			...
			<h3 class="text-white">
				Last updated: <span class="font-semibold">November 23, 2021</span>
			</h3>
		</div>
	</div>
</div>
						...
						<li>
							...
							<p>
								...
								statement if changes to the below statement are made (the <span class="font-bold"
									>“Final Payment Schedule”</span
								>). The Final Payment Schedule shall be delivered to you within 30 days after
												...
												<thead class="bg-gray-50">
													<tr>
														...
														<th
															...
															>Annual Percentage Rate (APR)</th
														>
														<th
															scope="col"
															class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
															>Your Selected Interest but cannot be more than 60% per annum</th
														>
													</tr>
												</thead>
												...
												<thead class="white">
													<tr>
														...
														<th
															scope="col"
															class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
															>Your Selected Interest but cannot be more than 60% per annum
														</th>
													</tr>
												</thead>
												<thead class="bg-gray-50">
												...
												<thead class="bg-white">
													<tr>
														...
														<th
															scope="col"
															class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
															>Total number of payments to be made by borrower (including down
															payment)
														</th>
														<th
															scope="col"
															class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
															>Depends on payment plan (bi-weekly/monthly option) and final booking
															price.
														</th>
													</tr>
												</thead>
												<thead class="bg-gray-50">
													<tr>
														...
														<th
															scope="col"
															class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
															>$0; except as expressly provided in Section 3 and Section 4 below.
														</th>
													</tr>
												</thead>
											</table>
